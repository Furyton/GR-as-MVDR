...
export DATA_BASE="/path/to/nq320k"

export QRELS=$DATA_BASE/qrel.dev.tsv
export TRIPLES=$DATA_BASE/triples.train.32.squeeze.tsv
...
export CANDIDATES=bm25.nq320k/candidate.json
export BM25_INDEX=bm25.nq320k.index
